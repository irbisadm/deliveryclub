 ...
 */
class Region extends \DC\ShowcaseBundle\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addCity($citys);
    }

    public function removeCity(\DC\ShowcaseBundle\Entity\City $citys)
    {
        $this->__load();
        return parent::removeCity($citys);
    }

    public function getCitys()
    {
        $this->__load();
        return parent::getCitys();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'active', 'removed', 'citys');
    }
